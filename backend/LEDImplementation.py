...
# CONFIG
MODEL_DIR = os.environ.get("MODEL_DIR", "./model/led")  # set to your model dir
# Or, for Hugging Face hub:
# MODEL_DIR = os.environ.get("MODEL_DIR", "allenai/led-base-16384")
...
def generate_abstract_using_led(text: str) -> str:
    """
